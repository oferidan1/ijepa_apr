...
def main(args, resume_preempt=False):
    ...
    if load_model:
        ...
        load_path = '/dsi/scratch/home/dsi/rinaVeler/USL_Project/ijepa_apr/checkpoint/IN1K-vit.h.14-300e.pth.tar'
    ...
    if data == 'imagenet':
        ...
        dataset = CambridgeDataset(
                root_path, "pose/datasets/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_Allscenes_train.csv", transform)
